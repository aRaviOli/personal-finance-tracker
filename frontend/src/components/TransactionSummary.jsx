...
export default function TransactionSummary({ transactions }) {
  ...
  return (
    <div className="mt-10 max-w-5xl mx-auto grid md:grid-cols-3 gap-6 text-sm hover:"
    ...
    >
      {[
        ...
        <div
          key={item.label}
          className="text-red bg-white rounded-lg shadow p-4 hover:shadow-md transition-all duration-200 animate-fadeSlideUp"
        >
